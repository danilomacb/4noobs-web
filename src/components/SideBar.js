      ...
      <nav ref={(element) => (nav = element)}>
        <ul id="main-list">
          <li id="home">
            <Link to="/">
              <img
                src={`${process.env.PUBLIC_URL}/images/he4rt.png`}
                alt="4noobs"
              />
            </Link>
          </li>
          ...
          <li id="credits">
            Desenvolvido por{' '}
            <a href="https://github.com/danilomacb">danilomacb</a>
          </li>
        </ul>
      </nav>
    </>
